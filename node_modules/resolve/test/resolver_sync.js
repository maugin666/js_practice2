...
test('bar', function (t) {
    ...
    t.equal(
        ...
        path.join(dir, 'bar/node_modules/foo/script.js')
    );
    t.end();
});
...
test('biz', function (t) {
    ...
    t.equal(
        ...
        path.join(dir, 'grux/script.js')
    );

    t.equal(
        resolve.sync('tiv', { basedir: path.join(dir, 'grux') }),
        path.join(dir, 'tiv/script.js')
    );
...
test('#25: node modules with the same name as node stdlib modules', function (t) {
    ...
    t.equal(
        ...
        path.join(resolverDir, 'node_modules/punycode/script.js')
    );
...
test('#52 - incorrectly resolves module-paths like "./someFolder/" when there is a file of the same name', function (t) {
    ...
    t.equal(
        resolve.sync('./foo/', { basedir: path.join(dir, 'same_names') }),
        path.join(dir, 'same_names/foo/script.js')
    );
    t.end();
});
