...
test('$NODE_PATH', function (t) {
    ...
    resolve('aaa', {
        ...
        t.equal(res, path.join(__dirname, '/node_path/x/aaa/script.js'));
    });
    ...
    resolve('bbb', {
        ...
        t.equal(res, path.join(__dirname, '/node_path/y/bbb/script.js'));
    });
    ...
    resolve('ccc', {
        ...
        t.equal(res, path.join(__dirname, '/node_path/x/ccc/script.js'));
    });
